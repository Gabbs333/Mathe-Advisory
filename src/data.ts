...
export const clients = [
  { name: "Brasaf", sector: "Agro-industrie", logo: "/logos/clients/Brasaf.jpeg" },
  { name: "Advans Cameroun", sector: "Microfinance", logo: "/logos/clients/advans.jpeg" },
  { name: "Cameroun Transit Transport & Logistic", sector: "Transit & Logistique", logo: "/logos/clients/cttl.jpeg" },
  { name: "Halles Déco", sector: "Décoration & BTP", logo: "/logos/clients/halles-deco.jpeg" },
  { name: "Fermencam", sector: "Agro-industrie", logo: "/logos/clients/fermencam.jpeg" },
  { name: "Krystal Palace Douala", sector: "Hôtellerie", logo: "/logos/clients/krystal-palace.jpeg" },
  { name: "Plasticam", sector: "Industrie Plastique", logo: "/logos/clients/plasticam.jpeg" },
  { name: "Unalor", sector: "Industrie", logo: "/logos/clients/unalor.jpeg" },
];

export const partners = [
  { name: "AXA", logo: "/logos/partenaires/axa.jpeg" },
  { name: "Saar", logo: "/logos/partenaires/saar.jpeg" },
  { name: "Chanas Assurances", logo: "/logos/partenaires/chanas.jpeg" },
  { name: "Zenithe", logo: "/logos/partenaires/zenithe.jpeg" },
  { name: "AGC", logo: "/logos/partenaires/AGC.jpeg" },
  { name: "NSIA", logo: "/logos/partenaires/nsia.jpeg" },
  { name: "AFG", logo: "/logos/partenaires/afg.jpeg" },
  { name: "ProAssur", logo: "/logos/partenaires/proassur.jpeg" },
  { name: "AREA", logo: "/logos/partenaires/area.jpeg" },
  { name: "CPA", logo: "/logos/partenaires/cpa.jpeg" },
  { name: "Sanlam Allianz", logo: "/logos/partenaires/sanlam-allianz.jpeg" },
  { name: "SUNU", logo: "/logos/partenaires/sunu.jpeg" },
  { name: "Wafa Assurance", logo: "/logos/partenaires/wafa.jpeg" },
  { name: "Acamvie", logo: "/logos/partenaires/acamvie.jpeg" },
  { name: "Belife", logo: "/logos/partenaires/belife.jpeg" },
  { name: "GMC", logo: "/logos/partenaires/gmc.jpeg" },
  { name: "LD Assurances", logo: "/logos/partenaires/ld assurances.jpeg" },
  { name: "WTW", logo: "/logos/partenaires/wtw.jpeg" },
  { name: "Activa", logo: "" },
  { name: "Royal Onyx", logo: "" },
  { name: "Prudential Beneficial", logo: "" },
];
